...
<!--     <link href="../assets/css/font-awesome.min.css" rel="stylesheet"> -->
  ...
  <body>
	...
	<nav class="menu" id="theMenu">
		<div class="menu-wrap">
			<h1 class="logo"><a href="../pages/index.jsp#home">LINK</a></h1>
			<i class="fa fa-arrow-right menu-close"></i>
			<a href="../pages/index.jsp">Home</a>
			<a href="../pages/services.jsp">Services</a>
			<a href="../pages/portfolio.jsp">Portfolio</a>
			<a href="../pages/about.jsp">About</a>
			<a href="#contact">Contact</a>
			<a href="https://www.facebook.com/MDAutomationsAndControls?fref=ts"><i class="fa fa-facebook"></i></a>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-4 dg">
					...
					<p class="centered"><a href="https://www.facebook.com/MDAutomationsAndControls?fref=ts"><i class="fa fa-facebook"></i></a></p>
...
<iframe width="100%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.co.in/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=tirupattur&amp;sll=20.983588,82.752628&amp;sspn=21.912797,39.506836&amp;ie=UTF8&amp;hq=&amp;hnear=Tirupattur,+Vellore,+Tamil+Nadu&amp;t=m&amp;z=13&amp;ll=12.498351,78.560199&amp;output=embed"></iframe>
				...
				<div class="col-lg-4">
					<h4>ADDRESS<br/><br>MD Automations Inc.</h4>
					<p>
  ...
  function DisplayIP(response) {
	   ...
	   ga('send', 'event', ipaddress, document.location.pathname);
